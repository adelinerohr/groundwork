...
function ContactImage(contact: Contact): React.JSX.Element {
  ...
  return (
    <div className="flex items-center justify-center p-6">
      <div className="relative">
        ...
        >
          <Avatar className={cn("size-28", "rounded-full")}>
            <AvatarFallback className={cn("size-28 text-2xl", "rounded-full")}>
...
function Properties(contact: Contact): React.JSX.Element {
