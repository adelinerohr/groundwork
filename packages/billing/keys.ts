...
export const keys = () =>
  createEnv({
    server: {
      ...
      BILLING_ENTERPRISE_PRODUCT_ID: z.string().optional(),
      BILLING_ENTERPRISE_PRODUCT_PRICE_ID: z.string().optional(),
    ...
    runtimeEnv: {
      ...
      BILLING_ENTERPRISE_PRODUCT_ID: process.env.BILLING_ENTERPRISE_PRODUCT_ID,
      BILLING_ENTERPRISE_PRODUCT_PRICE_ID: process.env.BILLING_ENTERPRISE_PRODUCT_PRICE_ID,
